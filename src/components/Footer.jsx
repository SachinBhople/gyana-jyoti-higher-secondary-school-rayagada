...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl rounded-full"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-orange-500/10 rounded-full blur-3xl rounded-full"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-green-500 flex items-center justify-center transition-all duration-300 hover:scale-110">
                <FaWhatsapp size={20} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Home', 'About', 'Facilities', 'Gallery', 'Admission', 'Contact'].map((link) => (
                <li key={link}>
                  <a href={`#${link.toLowerCase()}`} className="text-blue-100/80 hover:text-orange-400 transition-colors flex items-center gap-2 group">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="text-blue-100/80 hover:text-orange-400 transition-colors flex items-center gap-2 group cursor-pointer">
                 <span className="w-2 h-2 rounded-full border border-blue-400 group-hover:bg-orange-400 transition-colors"></span>
                 +2 Arts
              </li>
              <li className="text-blue-100/80 hover:text-orange-400 transition-colors flex items-center gap-2 group cursor-pointer">
        ...
        <div className="border-t border-white/10 pt-8 mt-12 text-center text-blue-100/60 text-sm flex flex-col items-center">
          ...
          <p className="mt-4 text-xs tracking-wider opacity-70 border-t border-white/5 pt-3 inline-block">
            Develop and Design by <span className="text-orange-400 font-semibold">Pooja Mandale</span>
          </p>
        </div>
      </div>
    </footer>
